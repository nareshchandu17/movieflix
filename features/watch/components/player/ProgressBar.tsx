...
export function ProgressBar() {
  ...
  const seekToPercent = usePlayerState(s => s.seekToPercent);
  const chapters = usePlayerState(s => s.chapters);
  const movieReactions = usePlayerState(s => s.movieReactions);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Reaction Ticks */}
        {duration > 0 && movieReactions.map((reaction: any) => (
          <div 
