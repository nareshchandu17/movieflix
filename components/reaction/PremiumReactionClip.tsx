                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex gap-2 bg-gray-800/50 rounded-lg p-1">
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded text-sm transition-all ${viewMode === 'single'
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded text-sm transition-all ${viewMode === 'split'
                                            ? 'bg-red-500 text-white'
                                            : 'text-gray-400 hover:text-white'
                                        }`}
                                >
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                {emotionOptions.map((emotion) => (
                                    <button
                                        ...
                                        className={`p-3 rounded-xl border transition-all duration-300 ${selectedEmotions.includes(emotion.id)
                    ...
                    {recordedClip && (
                        <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl border border-gray-700/50">
                            ...
                            <button
                                ...
                                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${isPublic ? 'bg-red-500' : 'bg-gray-600'
                                    }`}
                            >
                                <span
