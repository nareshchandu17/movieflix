    ...
    const fetchMovies = async () => {
      try {
        ...
        const promises: Promise<any>[] = [
          api.discover("movie", { language: "en", sortBy: "popularity.desc", page: 1 }),
          api.discover("movie", { language: "en", sortBy: "popularity.desc", page: 2 }),
        ];
        ...
        responses.forEach((res) => {
          const results = (res.results || []) as TMDBMovie[];
          all.push(
            ...results.map((m) => ({
              ...m,
