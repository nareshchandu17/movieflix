          ...
          >
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              <Button
                variant="outline"
                size="sm"
                className="border-cyan/30 text-cyan hover:bg-cyan/10 hover:border-cyan/50 rounded-full"
              >
              ...
              <Button
                variant="outline"
                size="sm"
                className="border-white/20 text-[#A7B0B7] hover:bg-white/5 hover:text-[#F4F6FA] rounded-full"
                onClick={handleCopy}
              >
                {copied ? (
