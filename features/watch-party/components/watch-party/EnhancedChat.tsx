...
import { ChatMessage, TypingUser } from "@/features/watch-party/services/chatPersistence";
...
export default function EnhancedChat({
  ...
  const MessageReactions = ({ messageId, reactions }: { messageId: string; reactions: { emoji: string; userName: string }[] }) => {
