...
// Compound indexes for scalability - optimized for common query patterns
ReactionClipSchema.index({ movieId: 1, showInMoviePage: 1, status: 1, createdAt: -1 });
ReactionClipSchema.index({ showInFeed: 1, status: 1, createdAt: -1 });
ReactionClipSchema.index({ userId: 1, status: 1, createdAt: -1 });
ReactionClipSchema.index({ status: 1, createdAt: -1 });
ReactionClipSchema.index({ movieId: 1, userId: 1 });
