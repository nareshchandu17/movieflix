    ...
    <AnimatePresence>
      {showNext && (
        <motion.div
          ...
          className="absolute bottom-[90px] right-8 z-50 bg-[rgba(20,20,20,0.96)] border border-white/10 rounded-md overflow-hidden flex shadow-2xl w-[320px] pointer-events-auto"
