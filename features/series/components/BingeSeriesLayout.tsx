...
import DetailedNarrativeMap from "./series/DetailedNarrativeMap";
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-4 mt-6">
                    <button
                      onClick={() => {
                        if (currentEpisode) {
                          handleEpisodePlay(currentEpisode.episode);
                        }
                      }}
                      className="px-8 py-3 bg-white text-black hover:bg-gray-200 rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg flex items-center gap-2"
                    >
                    ...
                    <button
                      onClick={() => {
                        router.push(`/watch-party?movieId=${id}`);
                      }}
                      className="px-8 py-3 bg-zinc-800/80 hover:bg-zinc-700/80 text-white backdrop-blur-md border border-white/20 rounded-lg font-semibold transition-all duration-300 hover:scale-105 shadow-lg flex items-center gap-2"
                    >
                      <PlayCircle className="w-5 h-5" />
                      Watch Party
                    </button>

                    <div className="flex items-center gap-3 sm:ml-2 mt-2 sm:mt-0">
                      <button className="w-12 h-12 flex items-center justify-center rounded-full border-2 border-white/30 bg-black/40 hover:bg-white/20 hover:border-white text-white transition-all duration-300 hover:scale-110">
                        <Download className="w-5 h-5" />
                      </button>
                      <button
                        ref={plusButtonRef}
                        onClick={(e) => handleAddClick(e)}
                        className="w-12 h-12 flex items-center justify-center rounded-full border-2 border-white/30 bg-black/40 hover:bg-white/20 hover:border-white text-white transition-all duration-300 hover:scale-110"
                      >
