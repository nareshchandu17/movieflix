  ...
  return (
    <div className="relative group/section py-6">
      ...
      <div className="relative">
        ...
        <div
          ref={scrollRef}
          className="flex gap-4 md:gap-6 overflow-x-auto overflow-y-visible scrollbar-hide scroll-smooth snap-x snap-mandatory px-4 sm:px-6 md:px-12 lg:px-20"
        ...
        >
          {movies.map((movie, index) => (
            <motion.div
              ...
              animate={{
                width: hoveredIndex === index ? 420 : 320,
              }}
              transition={{
              ...
              className="flex-shrink-0 h-[200px] snap-start"
            >
                <div 
                  className={`relative w-full h-full rounded-2xl overflow-hidden cursor-pointer border ${
                    hoveredIndex === index 
                      ? 'shadow-[0_0_60px_rgba(0,0,0,0.8)] border-white/30' 
