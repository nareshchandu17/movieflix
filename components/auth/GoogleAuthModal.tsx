      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 min-h-screen">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[400px] bg-[#111] border border-white/10 rounded-3xl p-8 shadow-2xl overflow-hidden flex flex-col items-center mx-auto"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full relative py-4 rounded-xl text-white font-bold tracking-wide text-sm
                bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20
                disabled:opacity-50 disabled:grayscale transition-all shadow-lg flex justify-center items-center gap-3 overflow-hidden group"
            >
              {isLoading ? (
