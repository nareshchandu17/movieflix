    ...
    <>
      <style>{`
        @media (min-width: 768px) {
          .mobile-nav-force-hide {
            display: none !important;
          }
        }
      `}</style>
      <nav className="fixed bottom-0 left-0 right-0 h-16 bg-black/80 backdrop-blur-2xl border-t border-white/10 z-[1200] flex items-center justify-around px-2 mobile-nav-force-hide">
