...
import { ChevronLeft, ChevronRight, Play, Star, TrendingUp, Calendar, Bell } from "lucide-react";
    ...
    const fetchRecommendations = async () => {
      try {
        ...
        const responses = await Promise.all([
          ...
          tmdbApi.discover('movie', { genre: '28', sortBy: 'vote_average.desc', page: 1 }), // High-rated action
          tmdbApi.getTrending('movie', 'day', 1), // Daily trending
          tmdbApi.discover('movie', { sortBy: 'vote_count.desc', page: 1 }) // Popular discussion
        ]);
    ...
    return (
      <div className="relative">
        <div className="flex items-center gap-3 mb-6">
          ...
          {userName && <span className="text-sm text-purple-400">Top Picks for {userName}</span>}
        </div>
