...
import { teluguApi } from "@/features/home/services/teluguApi";
import { hindiApi } from "@/features/home/services/hindiApi";
...
const PopularIndiaCarousel = () => {
  ...
  const fetchMovies = useCallback(async () => {
    try {
      ...
      const [teluguMovies, hindiMovies] = await Promise.allSettled([
        teluguApi.fetchTeluguMovies(20),
        hindiApi.fetchHindiMovies(20),
      ]);
      ...
      setIndianMovies(allIndianMovies.sort((a, b) => (b.rating || 0) - (a.rating || 0)).slice(0, 30));
    } catch (err) {
      console.error(err);
