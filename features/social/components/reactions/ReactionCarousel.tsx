...
import { ReactionCard } from "../fan-reactions/ReactionCard";
        ...
        {isLoading ? (
          ...
          <div 
            ...
            onScroll={(e) => {
              ...
              // Assuming each card is roughly 250-300px wide + gap
          ...
          >
            {reactions.map((reaction, index) => (
              <div key={reaction._id} className="snap-start flex-shrink-0">
                <ReactionCard reaction={reaction} isActive={index === activeIndex} />
              </div>
            ))}
